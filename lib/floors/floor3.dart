...
class ScreenFLoor3 extends StatefulWidget {
   ScreenFLoor3({required this.isAdmin,super.key});
bool isAdmin;
  @override
  State<ScreenFLoor3> createState() => _ScreenFLoor3State();
}

class _ScreenFLoor3State extends State<ScreenFLoor3> {
  ...
  Widget build(BuildContext context) {
    slots.getallslots();
     final filteredstudentss = slotlist.value
          .where((slots) => slots.category  == 'Floor3')
          .toList();
